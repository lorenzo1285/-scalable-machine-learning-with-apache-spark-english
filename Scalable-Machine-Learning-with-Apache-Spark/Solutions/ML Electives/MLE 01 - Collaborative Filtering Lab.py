...
seed = 42
cv = CrossValidator(numFolds=3, estimator=als, estimatorParamMaps=grid, evaluator=reg_eval, seed=seed)          
...
print(f"The model had a RMSE on the test set of {test_rmse:.3}")
